package fokus.wo.api.woprocess.model;
...
public class OrderHdrNonWo {
	...
	@Transient
	private List<String> listDONumber;
	...
	public List<String> getListDONumber() {
		return listDONumber;
	}

	public void setListDONumber(List<String> listDONumber) {
		this.listDONumber = listDONumber;
	}
